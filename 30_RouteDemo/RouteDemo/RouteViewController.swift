...
class RouteViewController: UIViewController, MKMapViewDelegate {
    ...
    @objc func pinLocation(sender: UILongPressGestureRecognizer) {
        ...
        // save this point and prepare for using
    ...
    func drawDirection(startPoint: CLLocationCoordinate2D, endPoint: CLLocationCoordinate2D) {
        ...
        // Set route form start point to end point
    ...
    @IBAction func removeAnnotation() {
        
        // Remove all the annotations and overlays
        mapView.removeOverlays(mapView.overlays)
        mapView.removeAnnotations(annotations)
        
        // Clear annotation array
