...
class AttachmentTableViewController: UITableViewController {
    ...
    func sendSMS(attachment: String) {
        ...
        // Check if device could send message or not
        guard MFMessageComposeViewController.canSendText() else {
            let alertMessage = UIAlertController(title: "SMS Unavailable", message: "Your device is not capable of send ing SMS", preferredStyle: .alert)
        ...
        messageController.body = "Just sent \(attachment) to your email. Please check!"
        ...
        // Show message viewController on the screen
