...
class ArticleTableViewController: UITableViewController {
    ...
    var animationEvent = Array(repeating: false, count: 6)
    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        guard animationEvent[indexPath.row] == true else {
            print("before animation \(animationEvent)")
            // Define default status before animation
                    cell.alpha = 0
            ...
            //        let rotationTransform = CATransform3DMakeRotation(rotationAngleInRadians, 0, 0, 1)
                    ...
                    UIView.animate(withDuration: 1.0, animations: { cell.alpha = 1; cell.layer.transform = CATransform3DIdentity })
                    self.animationEvent[indexPath.row] = true
            print("after animation  \(animationEvent)")
            return
        }
